...
> Judgement call: Section 16 has no explicit "must not" list. Inferred from Section 29's single-decision-per-module rule and RTK's scoped responsibility list.
